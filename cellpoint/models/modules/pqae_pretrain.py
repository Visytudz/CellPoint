...
class PQAEPretrain(pl.LightningModule):
    def __init__(self, cfg: DictConfig):
        ...
        self.cfg = cfg
        self.lambda1 = self.cfg.training.lambda1
        self.lambda2 = self.cfg.training.lambda2
        ...
        self.extractor = FeatureExtractor(
            grouping_cfg=params.grouping,
            patch_embed_cfg=params.patch_embed,
            encoder_cfg=params.encoder,
        )
        self.decoder = PointDecoder(
            positional_query_cfg=params.positional_query,
            reconstruction_head_cfg=params.reconstruction_head,
        )
        self.center_regressor = CenterRegressor(**params.center_regressor)

        # loss function and data augmentation
        self.loss_fn = ChamferLoss()
        self.train_transform = Compose.from_cfg(params.training.augmentations)
    ...
    def configure_optimizers(self):
        ...
        scheduler = CosineAnnealingLR(
            optimizer, T_max=self.cfg.training.epochs, eta_min=self.cfg.training.min_lr
        )
        ...
        self.log_dict(
            {
                ...
                "train/loss_cross": loss_cross,
                "train/loss_self": loss_self,
                "train/loss_center": loss_center,
            },
            prog_bar=True,
        )
