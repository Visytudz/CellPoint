...
class PQAEClassifier(pl.LightningModule):
        ...
        params = [
            {
                ...
                "lr": self.cfg.training.extractor_lr,
            },
            {
                "params": self.classification_head.parameters(),
                "lr": self.cfg.training.head_lr,
            },
        ]
        optimizer = AdamW(params, weight_decay=self.cfg.training.weight_decay)
